            ...
            <header class="p-3 text-bg-dark border-bottom">
                <div class="container">
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <a href="/CarManager/index.php" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none nav-link">
                        ...
                        <ul class="nav gap-3 mx-auto">
                            <li class="nav-item">
                                <a href="/CarManager/src/carro/index.php" class="nav-link px-2 text-white d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                <a href="/CarManager/src/proprietario/index.php" class="nav-link px-2 text-white d-flex align-items-center">
