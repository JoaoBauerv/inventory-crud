    ...
    <div class="card shadow-lg bg-dark p-4" style="width: 100%; max-width: 400px;">
        ...
        <?php if ($usuario): ?>
            <ul class="list-group list-group-flush">
                <li class="list-group-item bg-dark text-white"><strong>Nome:</strong> <?php echo htmlspecialchars($usuario['usuario']); ?></li>
                <li class="list-group-item bg-dark text-white"><strong>Usuário:</strong> <?php echo htmlspecialchars($usuario['usuario']); ?></li>
                <li class="list-group-item bg-dark text-white"><strong>Email:</strong> <?php echo htmlspecialchars($usuario['email']); ?></li>
            </ul>
        <?php else: ?>
